...
class RetrofitConfigModule {
    ...
    @Singleton
    @Provides
    fun trelloBoardApi(retrofit: Retrofit) = retrofit.create(TrelloBoardsApi::class.java)

    @Singleton
    @Provides
    fun trelloListApi(retrofit: Retrofit) = retrofit.create(TrelloListApi::class.java)
}